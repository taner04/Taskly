...
namespace Taskly.WebApi.Features.Attachments.Common.Services;
    ...
    BlobServiceClient blobServiceClient)
{
        ...
        Attachment attachment)
    {
        ...
        return new SasUploadResult(sasUri.ToString());
    }
    ...
    // Records
    internal sealed record SasDownloadResult(string DownloadUrl);

    internal sealed record SasUploadResult(string UploadUrl);
}